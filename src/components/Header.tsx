        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between h-20">
            ...
            <div className="hidden md:flex items-center space-x-4">
              <button onClick={() => setShowContactForm(true)} className="text-[#0F172A] hover:text-[#0EA5A4] flex items-center gap-2 smooth-hover p-2 rounded-lg hover:bg-[#FAF7F2] transition-all" aria-label="Open contact form">
                <svg
                  className="w-6 h-6"
                  fill="none"
                  stroke="currentColor"
        ...
        {isMenuOpen && (
          <div className="md:hidden pb-4 animate-fade-in">
            <nav className="flex flex-col space-y-4">
              ...
              <button onClick={() => setShowContactForm(true)} className="text-[#0F172A] hover:text-[#0EA5A4] font-medium smooth-hover py-2 px-3 rounded-lg hover:bg-[#FAF7F2]">
                Help
              </button>
            </nav>
          </div>
