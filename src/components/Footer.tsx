    ...
    <footer className="bg-gray-900 text-white">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Brand */}
          <div>
            <h3 className="text-xl font-bold mb-4">YourBrand Tours</h3>
          ...
          {/* Get Help */}
          <div>
            <h4 className="font-semibold mb-4">Get Help 24/7</h4>
            <ul className="space-y-2 text-sm text-gray-400">
              <li>
                <a href="mailto:support@yourbrand.com" className="hover:text-white">
          ...
          <div>
            ...
            <div className="space-y-2">
              <a
                href="#"
                className="block bg-gray-800 hover:bg-gray-700 rounded-lg p-2 transition-colors"
              >
