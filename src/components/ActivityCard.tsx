...
export default function ActivityCard({ activity, destination, formatPrice }: ActivityCardProps) {
  ...
  return (
    <div className="group bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-2xl transition-all duration-300 ring-1 ring-black/5 hover:ring-blue-500/20 hover:-translate-y-1">
      ...
      <div className="p-5">
        ...
        <div className="flex flex-col gap-2">
          ...
          <Link
            ...
            className="w-full py-2.5 rounded-xl bg-gradient-to-r from-gray-50 to-gray-100 hover:from-blue-50 hover:to-blue-100 text-gray-900 font-semibold text-sm transition-all duration-300 ring-1 ring-gray-200 hover:ring-blue-300 hover:shadow-md text-center"
          >
            View Details →
          </Link>
        </div>
