  ...
  return (
    ...
    >
      ...
      <div className="mx-auto max-w-7xl px-4 py-6 lg:h-full">
        {/* Card fills height */}
        <div
          className="h-auto rounded-[28px] bg-white shadow-[0_25px_70px_-35px_rgba(0,0,0,0.35)] ring-1 ring-black/5 lg:h-full"
        ...
        >
          ...
          <div className="grid gap-6 p-5 md:p-7 lg:h-full lg:min-h-0 lg:grid-cols-12 lg:items-stretch">
            ...
            <div className="lg:col-span-7 lg:flex lg:h-full lg:min-h-0 lg:flex-col">
              ...
              <div className="relative overflow-hidden rounded-[22px] bg-slate-100 ring-1 ring-black/5 lg:flex-1 lg:min-h-0">
                ...
                <div className="relative h-[340px] md:h-[420px] lg:h-full">
                  ...
                  <div className="absolute left-4 top-4 flex flex-wrap gap-2">
                    {destinationId ? (
                      <span className="rounded-full bg-white/90 px-3 py-1 text-xs font-semibold text-slate-900 ring-1 ring-black/5 backdrop-blur">
                  ...
                  <div className="absolute bottom-4 left-4 right-20">
                    <h2
                      className="text-lg font-bold text-white drop-shadow md:text-xl whitespace-nowrap overflow-hidden truncate"
                      title={title}
                    >
                      {title}
                    </h2>
                  ...
                  {len > 1 ? (
                    <>
                      <button
                        onClick={prevFn}
                        className="absolute left-4 top-1/2 -translate-y-1/2 rounded-full bg-white/75 p-3 shadow-lg ring-1 ring-black/10 backdrop-blur hover:bg-white focus:outline-none focus:ring-2 focus:ring-blue-500"
                        aria-label="Previous"
                      >
                      ...
                      <button
                        onClick={next}
                        className="absolute right-4 top-1/2 -translate-y-1/2 rounded-full bg-white/75 p-3 shadow-lg ring-1 ring-black/10 backdrop-blur hover:bg-white focus:outline-none focus:ring-2 focus:ring-blue-500"
                        aria-label="Next"
                      >
                        <svg className="h-5 w-5 text-slate-800" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              {len > 1 ? (
                <div className="mt-3 flex items-center justify-between gap-3">
                  ...
                  <button
                    ...
                    className="rounded-full bg-white px-3 py-1.5 text-xs font-semibold text-slate-900 shadow-sm ring-1 ring-black/10 hover:bg-slate-50"
            ...
            <div className="lg:col-span-5 lg:h-full lg:min-h-0">
              ...
              <div className="flex h-full min-h-0 flex-col rounded-[22px] bg-white ring-1 ring-black/5">
                {/* Top (fixed) */}
                <div className="p-5 md:p-6">
                  ...
                  <h1
                    className="text-lg font-extrabold leading-tight text-slate-900 md:text-xl whitespace-nowrap overflow-hidden truncate"
                    title={title}
                  >
                    {title}
                  </h1>
                  ...
                  <div className="mt-4 grid gap-3 sm:grid-cols-2">
                    <div className="rounded-2xl bg-slate-900 px-4 py-3 text-white">
                      <div className="text-xs font-semibold text-white/80">{priceSub}</div>
                ...
                <div className="min-h-0 flex-1 overflow-auto px-5 pb-4 md:px-6">
                  {bullets.length ? (
                    <ul className="space-y-3">
                      {bullets.map((b, i) => (
                        <li key={i} className="flex items-start gap-3">
                          <span className="mt-1 inline-flex h-5 w-5 flex-shrink-0 items-center justify-center rounded-full bg-slate-900 text-white">
                            <svg className="h-3.5 w-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={3} d="M5 13l4 4L19 7" />
                            </svg>
                          </span>
                          <p className="text-sm leading-relaxed text-slate-700 whitespace-nowrap overflow-hidden truncate" title={b}>
                            {b}
                          </p>
                        </li>
                      ))}
                    ...
                    <p
                      className="text-sm text-slate-700 whitespace-nowrap overflow-hidden truncate"
